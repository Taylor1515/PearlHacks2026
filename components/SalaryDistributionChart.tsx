...
const confidenceColors = {
  high: "#10b981",    // Green (matches --chart-3)
  medium: "#f59e0b",  // Amber (matches --chart-2)
  low: "#ef4444",     // Red (matches --chart-1)
};
...
const CHART_PRIMARY = "#6468f0";  // Primary purple
const BORDER_COLOR = "#d0d4db";
const MUTED_FOREGROUND = "#6c727e";
      ...
      <ChartContainer config={chartConfig} className="h-[220px] w-full">
        ...
        >
          ...
          <XAxis
            ...
            tick={{ fontSize: 11, fill: MUTED_FOREGROUND }}
            axisLine={false}
            tickLine={false}
          />
